...
import type { LoanStatus, RepaymentType, RequestStatus } from '../../src/types.ts'
...
export const fundingRequests = pgTable(
  'funding_requests',
  {
    ...
    repaymentType: text('repayment_type').$type<RepaymentType>().notNull(),
...
export const fundings = pgTable(
  'fundings',
  {
    ...
    status: text('status').$type<'held' | 'released' | 'refunded' | 'cancelled'>().notNull().default('held'),
...
export const loans = pgTable(
  'loans',
  {
    ...
    termDays: integer('term_days').notNull(),
    repaymentType: text('repayment_type').$type<RepaymentType>().notNull(),
    status: text('status').$type<LoanStatus>().notNull().default('disbursed'),
